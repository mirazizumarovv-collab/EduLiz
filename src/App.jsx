...
function PinLockScreen() {
  ...
  const sendCode = () => {
    // No real SMS gateway in this demo — the code is generated locally and
    // shown on-screen instead of actually being sent, but the verification
    // flow itself (code -> new PIN) is fully real, not skipped.
