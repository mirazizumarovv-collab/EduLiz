  ...
  return (
    <div style={{ padding: "18px 16px 8px" }}>
      ...
      {!loading && !error && (() => {
        ...
        const strongest = subjects.reduce((a, b) => (b.score > a.score ? b : a));
          ...
          <>
            <Section title={t("quickSummary")}>
              <div style={{ fontSize: 12.5, color: c.textPrimary, background: c.surfaceAlt, borderRadius: 10, padding: 14, lineHeight: 1.6 }}>
                {t("profileSummaryText", { name: selectedStudent.name, avg: overallAvg, rate, subject: subj(lang, strongest.name) })}
              </div>
            </Section>
